...
public:
  Listing_intersection_traits_ray_or_segment_triangle(Output_iterator out_it, const AABBTraits& traits)
  ...
  void intersection(const Query& query, const Primitive& primitive)
  {
    ...
    if ( GeomTraits().do_intersect_3_object()(query,primitive.datum(m_traits.shared_data())) ){
