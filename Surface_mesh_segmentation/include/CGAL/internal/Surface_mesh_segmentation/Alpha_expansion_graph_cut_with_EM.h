...
public:
    ...
    Alpha_expansion_graph_cut_with_EM(const std::vector<std::pair<int, int> >& edges,
        const std::vector<double>& edge_weights, std::vector<int>& labels, std::vector<double>& data,
        std::vector<std::vector<double> >& probability_matrix, std::vector<int>& center_ids)
    {
        apply_alpha_expansion_with_em(edges, edge_weights, probability_matrix, data, labels);
        center_ids = labels;
    }
    ...
    void apply_alpha_expansion_with_em(const std::vector<std::pair<int, int> >& edges,
        const std::vector<double>& edge_weights, std::vector<std::vector<double> >& probability_matrix, std::vector<double>& data,
        std::vector<int>& labels)
    {
        ...
        do {
            ...
            Expectation_maximization(data).refresh_parameters_and_probabilities(matrix_size, labels, probability_matrix);              
        } while(success);
