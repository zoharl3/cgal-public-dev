...
{   
    ...
    for(typename std::vector<Gaussian_point>::const_iterator it = points.begin(); it != points.end(); ++it)
    {
...
public:
    ...
    void initiate_centers(int number_of_centers)
    {
        ...
        for(int i = 0; i < number_of_centers; ++i)
        {
            ...
            Gaussian_center center(initial_mean, initial_deviation, initial_mixing_coefficient);
