...
protected:
    ...
    void write_random_centers(const char* file_name, const std::vector<int>& center_indexes)
    {
        std::ofstream output(file_name, std::ios_base::app);
        for(std::vector<int>::const_iterator it = center_indexes.begin(); it != center_indexes.end(); ++it)
        {
