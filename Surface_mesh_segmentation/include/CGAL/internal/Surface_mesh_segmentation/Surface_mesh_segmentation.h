                            ...
                            int number_of_ray = CGAL_DEFAULT_NUMBER_OF_RAYS)
{
    ...
    SDF_calculation_class().calculate_sdf_values(mesh, sdf_pmap, cone_angle, number_of_ray);
     ...
     int number_of_rays = CGAL_DEFAULT_NUMBER_OF_RAYS)
{
    ...
    SDF_calculation_class().calculate_sdf_values(mesh, sdf_pmap_internal, cone_angle, number_of_rays);
...
{    
    typedef Polyhedron_property_map_for_facet<Polyhedron, double, FacetIndexMap> Facet_vector_map;
