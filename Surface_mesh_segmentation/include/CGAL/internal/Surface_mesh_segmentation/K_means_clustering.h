...
public:
    ...
    void forgy_initialization(std::size_t number_of_centers, const std::vector<T1>& points, std::vector<T2>& centers, CGAL::Random& random)
    {
        ...
        {    
            ...
            std::size_t random_index = random.get_int(0, random_range + 1); // [0, random_range];
    ...
    */
     ...
     */
    template<class T1, class T2>
    void plus_plus_initialization(std::size_t number_of_centers, const std::vector<T1>& points, std::vector<T2>& centers, CGAL::Random& random)
    {
        centers.reserve(number_of_centers);
        ...
        std::size_t initial_index = random.get_int(0, points.size()); // [0, points size)
...
public:
    ...
    K_means_point(double data, std::size_t center_id = -1) : data(data), center_id(center_id)
    { }
...
public:
    ...
    {  
        CGAL_precondition(data.size() >= number_of_centers && "Number of centers can not be more than number of data.");
