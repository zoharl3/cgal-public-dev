...
public:
    ...
    public:
        ...
        Parameters(double cone_angle = CGAL_DEFAULT_CONE_ANGLE, int number_of_rays = CGAL_DEFAULT_NUMBER_OF_RAYS)
...
public:   
    ...
    : parameters(parameters), use_minimum_segment(false), multiplier_for_segment(1)
    { }
    
    void calculate_sdf_values(Polyhedron& mesh, std::map<Facet_handle, double>& sdf_values)
    {
...
protected:
    ...
    boost::tuple<double, double> calculate_sdf_value_from_rays( std::vector<double>& ray_distances,
