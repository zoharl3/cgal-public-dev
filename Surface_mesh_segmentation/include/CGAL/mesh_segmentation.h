                                           ...
                                           double smoothing_lambda = 0.26)
{
    ...
    internal::Surface_mesh_segmentation<Polyhedron> algorithm(polyhedron);
    return algorithm.partition(number_of_levels, smoothing_lambda, sdf_values, segment_ids);
}
...
sdf_values_computation(const Polyhedron& polyhedron, 
                        ...
                        int number_of_rays = 25)
{
  return sdf_values_computation<Polyhedron, SDFPropertyMap, typename Polyhedron::Traits>(polyhedron, sdf_values, cone_angle, number_of_rays);
}
...
surface_mesh_segmentation_from_sdf_values(const Polyhedron& polyhedron, 
                                           ...
                                           double smoothing_lambda = 0.26)
{
  return surface_mesh_segmentation_from_sdf_values<Polyhedron, SDFPropertyMap, SegmentPropertyMap, typename Polyhedron::Traits>(polyhedron, sdf_values, segment_ids, number_of_levels, smoothing_lambda);
}
                           ...
                           double smoothing_lambda = 0.26)
{
  return surface_mesh_segmentation<Polyhedron, SegmentPropertyMap, typename Polyhedron::Traits>
    (polyhedron, segment_ids, cone_angle, number_of_rays, number_of_levels, smoothing_lambda);
}
#endif
