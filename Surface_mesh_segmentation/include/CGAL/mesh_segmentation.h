 ...
 */
template <bool fast_bbox_intersection, class Polyhedron, class SDFPropertyMap, class GeomTraits
...
{
    internal::Surface_mesh_segmentation<Polyhedron, GeomTraits, fast_bbox_intersection> algorithm(polyhedron, traits);
 ...
 * @return number of segments
 */ 
template < bool fast_bbox_intersection, class Polyhedron, class SegmentPropertyMap, class GeomTraits
#ifndef BOOST_NO_FUNCTION_TEMPLATE_DEFAULT_ARGS
  = typename Polyhedron::Traits
#endif
>
