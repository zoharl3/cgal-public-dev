            ...
            GeomTraits traits = GeomTraits())
{
    ...
    return algorithm.calculate_sdf_values(cone_angle, number_of_rays, sdf_values_map, postprocess);
}
/// @endcond
...
sdf_values_postprocessing(const Polyhedron& polyhedron, SDFPropertyMap sdf_values_map) {
    ...
    return internal::Postprocess_sdf_values<Polyhedron>().postprocess(polyhedron, sdf_values_map);
}
                            ...
                            GeomTraits traits = GeomTraits())
{
    ...
    return segmentation_from_sdf_values<Polyhedron, boost::associative_property_map<Facet_double_map>, SegmentPropertyMap, GeomTraits>
        (polyhedron, sdf_property_map, segment_ids, number_of_clusters, smoothing_lambda, output_cluster_ids, traits);
}
/// \endcond
                            ...
                            GeomTraits traits = GeomTraits())
{
    return segmentation_via_sdf_values<true, Polyhedron, SegmentPropertyMap, GeomTraits>
      (polyhedron, segment_ids, cone_angle, number_of_rays, number_of_clusters, smoothing_lambda, output_cluster_ids, traits);
}
                                           ...
                                           typename Polyhedron::Traits traits = typename Polyhedron::Traits())
{
    return segmentation_from_sdf_values<Polyhedron, SDFPropertyMap, SegmentPropertyMap, typename Polyhedron::Traits>
        (polyhedron, sdf_values_map, segment_ids, number_of_clusters, smoothing_lambda, output_cluster_ids, traits);
}
