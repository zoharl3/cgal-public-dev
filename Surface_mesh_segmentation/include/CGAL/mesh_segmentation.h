...
{ 
    ...
    return algorithm.partition(number_of_clusters, smoothing_lambda, sdf_values, segment_ids, !output_cluster_ids);
}
                                           ...
                                           typename Polyhedron::Traits traits = typename Polyhedron::Traits())
{
    return segment_from_sdf_values<Polyhedron, SDFPropertyMap, SegmentPropertyMap, typename Polyhedron::Traits>
        (polyhedron, sdf_values, segment_ids, number_of_clusters, smoothing_lambda, output_cluster_ids, traits);
}
