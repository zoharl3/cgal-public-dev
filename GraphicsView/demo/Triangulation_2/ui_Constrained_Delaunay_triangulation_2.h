...
**
** Created: Mon Jul 8 09:48:22 2013
...
public:
    ...
    void setupUi(QMainWindow *Constrained_Delaunay_triangulation_2)
    {
        ...
        actionVoronoiDiagram = new QAction(Constrained_Delaunay_triangulation_2);
        actionVoronoiDiagram->setObjectName(QString::fromUtf8("actionVoronoiDiagram"));
        actionVoronoiDiagram->setCheckable(true);
        QIcon icon11;
        icon11.addFile(QString::fromUtf8(":/cgal/Actions/icons/cdt.png"), QSize(), QIcon::Normal, QIcon::Off);
        actionVoronoiDiagram->setIcon(icon11);
        ...
        toolBar->addAction(actionVoronoiDiagram);
        toolBar->addSeparator();
...
#endif // QT_NO_TOOLTIP
        actionVoronoiDiagram->setText(QApplication::translate("Constrained_Delaunay_triangulation_2", "Voronoi Diagra&m", 0, QApplication::UnicodeUTF8));
