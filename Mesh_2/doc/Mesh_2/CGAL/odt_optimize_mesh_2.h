...
The function `odt_optimize_mesh_2()` is a mesh optimization process 
based on the minimization of a global energy function. 

In `odt_optimize_mesh_2()`, the minimized global energy may be interpreted 
...
The optimizer `odt_optimize_mesh_2()` works in iterative steps. 
